...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/bilonjea/jhdemo)
...
To build the final jar and optimize the jhdemo application for production, run:
